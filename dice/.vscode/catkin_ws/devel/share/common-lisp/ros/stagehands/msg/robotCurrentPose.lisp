...
(cl:defmethod cl:initialize-instance :after ((m <robotCurrentPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robotCurrentPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stagehands-msg:<robotCurrentPose> is deprecated: use stagehands-msg:robotCurrentPose instead.")))

(cl:ensure-generic-function 'robot_id-val :lambda-list '(m))
(cl:defmethod robot_id-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands-msg:robot_id-val is deprecated.  Use stagehands-msg:robot_id instead.")
  (robot_id m))

(cl:ensure-generic-function 'xPos-val :lambda-list '(m))
(cl:defmethod xPos-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands-msg:xPos-val is deprecated.  Use stagehands-msg:xPos instead.")
  (xPos m))

(cl:ensure-generic-function 'yPos-val :lambda-list '(m))
(cl:defmethod yPos-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands-msg:yPos-val is deprecated.  Use stagehands-msg:yPos instead.")
  (yPos m))

(cl:ensure-generic-function 'rotationQuaternion-val :lambda-list '(m))
(cl:defmethod rotationQuaternion-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands-msg:rotationQuaternion-val is deprecated.  Use stagehands-msg:rotationQuaternion instead.")
