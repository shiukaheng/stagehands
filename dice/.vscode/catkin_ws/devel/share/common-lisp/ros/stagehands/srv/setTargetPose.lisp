...
(cl:defmethod cl:initialize-instance :after ((m <setTargetPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setTargetPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stagehands-srv:<setTargetPose-request> is deprecated: use stagehands-srv:setTargetPose-request instead.")))

(cl:ensure-generic-function 'xPos-val :lambda-list '(m))
(cl:defmethod xPos-val ((m <setTargetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands-srv:xPos-val is deprecated.  Use stagehands-srv:xPos instead.")
  (xPos m))

(cl:ensure-generic-function 'yPos-val :lambda-list '(m))
(cl:defmethod yPos-val ((m <setTargetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands-srv:yPos-val is deprecated.  Use stagehands-srv:yPos instead.")
  (yPos m))

(cl:ensure-generic-function 'thetaPos-val :lambda-list '(m))
(cl:defmethod thetaPos-val ((m <setTargetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands-srv:thetaPos-val is deprecated.  Use stagehands-srv:thetaPos instead.")
  (thetaPos m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<setTargetPose-request>)))
  ...
  "stagehands/setTargetPoseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'setTargetPose-request)))
  "Returns string type for a service object of type 'setTargetPose-request"
  "stagehands/setTargetPoseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <setTargetPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setTargetPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stagehands-srv:<setTargetPose-response> is deprecated: use stagehands-srv:setTargetPose-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <setTargetPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands-srv:response-val is deprecated.  Use stagehands-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<setTargetPose-response>)))
  ...
  "stagehands/setTargetPoseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'setTargetPose-response)))
  "Returns string type for a service object of type 'setTargetPose-response"
  "stagehands/setTargetPoseResponse")
