...
if("TRUE" STREQUAL "TRUE")
  set(hector_imu_tools_SOURCE_PREFIX /afs/inf.ed.ac.uk/user/s20/s2030247/Documents/stagehands/basebot/catkin_ws/src/hector_slam/hector_imu_tools)
  set(hector_imu_tools_DEVEL_PREFIX /afs/inf.ed.ac.uk/user/s20/s2030247/Documents/stagehands/basebot/catkin_ws/devel)
  ...
  set(hector_imu_tools_INSTALL_PREFIX /afs/inf.ed.ac.uk/user/s20/s2030247/Documents/stagehands/basebot/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_imu_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/afs/inf.ed.ac.uk/user/s20/s2030247/Documents/stagehands/basebot/catkin_ws/src/hector_slam/hector_imu_tools/${idir}'.  ${_report}")
    endif()
