...
(cl:in-package stagehands_custom_nodes-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <robotCurrentPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robotCurrentPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stagehands_custom_nodes-msg:<robotCurrentPose> is deprecated: use stagehands_custom_nodes-msg:robotCurrentPose instead.")))

(cl:ensure-generic-function 'robot_id-val :lambda-list '(m))
(cl:defmethod robot_id-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_custom_nodes-msg:robot_id-val is deprecated.  Use stagehands_custom_nodes-msg:robot_id instead.")
  (robot_id m))

(cl:ensure-generic-function 'xPos-val :lambda-list '(m))
(cl:defmethod xPos-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_custom_nodes-msg:xPos-val is deprecated.  Use stagehands_custom_nodes-msg:xPos instead.")
  (xPos m))

(cl:ensure-generic-function 'yPos-val :lambda-list '(m))
(cl:defmethod yPos-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_custom_nodes-msg:yPos-val is deprecated.  Use stagehands_custom_nodes-msg:yPos instead.")
  (yPos m))

(cl:ensure-generic-function 'rotationQuaternion-val :lambda-list '(m))
(cl:defmethod rotationQuaternion-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_custom_nodes-msg:rotationQuaternion-val is deprecated.  Use stagehands_custom_nodes-msg:rotationQuaternion instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robotCurrentPose>)))
  ...
  "stagehands_custom_nodes/robotCurrentPose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robotCurrentPose)))
  "Returns string type for a message object of type 'robotCurrentPose"
  "stagehands_custom_nodes/robotCurrentPose")
