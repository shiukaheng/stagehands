...
(cl:in-package stagehands_custom_nodes-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <setTargetPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setTargetPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stagehands_custom_nodes-srv:<setTargetPose-request> is deprecated: use stagehands_custom_nodes-srv:setTargetPose-request instead.")))

(cl:ensure-generic-function 'xPos-val :lambda-list '(m))
(cl:defmethod xPos-val ((m <setTargetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_custom_nodes-srv:xPos-val is deprecated.  Use stagehands_custom_nodes-srv:xPos instead.")
  (xPos m))

(cl:ensure-generic-function 'yPos-val :lambda-list '(m))
(cl:defmethod yPos-val ((m <setTargetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_custom_nodes-srv:yPos-val is deprecated.  Use stagehands_custom_nodes-srv:yPos instead.")
  (yPos m))

(cl:ensure-generic-function 'thetaPos-val :lambda-list '(m))
(cl:defmethod thetaPos-val ((m <setTargetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_custom_nodes-srv:thetaPos-val is deprecated.  Use stagehands_custom_nodes-srv:thetaPos instead.")
  (thetaPos m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<setTargetPose-request>)))
  ...
  "stagehands_custom_nodes/setTargetPoseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'setTargetPose-request)))
  "Returns string type for a service object of type 'setTargetPose-request"
  "stagehands_custom_nodes/setTargetPoseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <setTargetPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setTargetPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stagehands_custom_nodes-srv:<setTargetPose-response> is deprecated: use stagehands_custom_nodes-srv:setTargetPose-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <setTargetPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_custom_nodes-srv:response-val is deprecated.  Use stagehands_custom_nodes-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<setTargetPose-response>)))
  ...
  "stagehands_custom_nodes/setTargetPoseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'setTargetPose-response)))
  "Returns string type for a service object of type 'setTargetPose-response"
  "stagehands_custom_nodes/setTargetPoseResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'setTargetPose)))
  ...
  "stagehands_custom_nodes/setTargetPose")