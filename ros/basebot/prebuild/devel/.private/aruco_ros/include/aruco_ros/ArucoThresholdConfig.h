...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ArucoThresholdConfig::AbstractParamDescriptionConstPtr(new ArucoThresholdConfig::ParamDescription<int>("detection_mode", "int", 0, "The detection mode , affects speed and reliability", "{'enum': [{'name': 'Normal', 'type': 'int', 'value': 0, 'srcline': 12, 'srcfile': '/catkin_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg', 'description': '', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Fast', 'type': 'int', 'value': 1, 'srcline': 13, 'srcfile': '/catkin_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg', 'description': '', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Video_Fast', 'type': 'int', 'value': 2, 'srcline': 14, 'srcfile': '/catkin_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg', 'description': '', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'detection_mode enum'}", &ArucoThresholdConfig::detection_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 12 "/catkin_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg"
      const int ArucoThreshold_Normal = 0;
//#line 13 "/catkin_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg"
      const int ArucoThreshold_Fast = 1;
//#line 14 "/catkin_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg"
