...
"""autogenerated by genpy from stagehands_ros/robotCurrentPose.msg. Do not edit."""
import codecs
import sys
...
class robotCurrentPose(genpy.Message):
  _md5sum = "4e7b217eea6103e03ece87b56ae7b5b5"
  _type = "stagehands_ros/robotCurrentPose"
...
# float64 currentFlashFrequency"""
  __slots__ = ['robot_id','xPos','yPos','rotationQuaternion','currentMicHeight']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       robot_id,xPos,yPos,rotationQuaternion,currentMicHeight
    ...
    if args or kwds:
      ...
      if self.currentMicHeight is None:
        self.currentMicHeight = 0.
    else:
      self.robot_id = ''
      self.xPos = 0.
      self.yPos = 0.
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.currentMicHeight,) = _get_struct_d().unpack(str[start:end])
      return self
