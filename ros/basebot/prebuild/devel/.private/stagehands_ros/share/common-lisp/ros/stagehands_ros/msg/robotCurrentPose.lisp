...
(cl:defclass <robotCurrentPose> (roslisp-msg-protocol:ros-message)
  ((robot_id
   ...
   (currentMicHeight
    :reader currentMicHeight
    :initarg :currentMicHeight
    :type cl:float
    :initform 0.0))
)
...
(cl:ensure-generic-function 'currentMicHeight-val :lambda-list '(m))
(cl:defmethod currentMicHeight-val ((m <robotCurrentPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stagehands_ros-msg:currentMicHeight-val is deprecated.  Use stagehands_ros-msg:currentMicHeight instead.")
  (currentMicHeight m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robotCurrentPose>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'currentMicHeight))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robotCurrentPose>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'rotationQuaternion)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'currentMicHeight) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robotCurrentPose>)))
  ...
  "4e7b217eea6103e03ece87b56ae7b5b5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robotCurrentPose)))
  "Returns md5sum for a message object of type 'robotCurrentPose"
  "4e7b217eea6103e03ece87b56ae7b5b5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robotCurrentPose>)))
  ...
  (cl:format cl:nil "string robot_id~%float64 xPos~%float64 yPos~%float64[] rotationQuaternion~%float64 currentMicHeight~%# string currentLEDAnimation~%# int[] currentLEDColour~%# float64 currentFlashFrequency~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robotCurrentPose)))
  "Returns full string definition for message of type 'robotCurrentPose"
  (cl:format cl:nil "string robot_id~%float64 xPos~%float64 yPos~%float64[] rotationQuaternion~%float64 currentMicHeight~%# string currentLEDAnimation~%# int[] currentLEDColour~%# float64 currentFlashFrequency~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <robotCurrentPose>))
  ...
  (cl:list 'robotCurrentPose
    ...
    (cl:cons ':currentMicHeight (currentMicHeight msg))
))
