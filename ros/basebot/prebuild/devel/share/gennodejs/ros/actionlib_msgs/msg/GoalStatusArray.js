...
const GoalStatus = require('./GoalStatus.js');
...
class GoalStatusArray {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.status_list.length; ++i) {
      length += GoalStatus.getMessageSize(object.status_list[i]);
    }
  ...
  static datatype() {
    // Returns string type for a actionlib_msgs/GoalStatusArray object
