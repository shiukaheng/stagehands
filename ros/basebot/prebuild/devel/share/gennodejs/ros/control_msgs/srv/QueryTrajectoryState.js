...
class QueryTrajectoryStateRequest {
  ...
  static datatype() {
    // Returns string type for a control_msgs/QueryTrajectoryStateRequest object
...
class QueryTrajectoryStateResponse {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.name.length; ++i) {
      length += 4 + _getByteLength(object.name[i]);
    }
  ...
  static datatype() {
    // Returns string type for a control_msgs/QueryTrajectoryStateResponse object
...
module.exports = {
  ...
  datatype() { return 'control_msgs/QueryTrajectoryState'; }
};
