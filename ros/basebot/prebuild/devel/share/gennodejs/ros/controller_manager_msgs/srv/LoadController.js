...
class LoadControllerRequest {
  ...
  static datatype() {
    // Returns string type for a controller_manager_msgs/LoadControllerRequest object
...
class LoadControllerResponse {
  ...
  static datatype() {
    // Returns string type for a controller_manager_msgs/LoadControllerResponse object
