...
const Config = require('../msg/Config.js');
...
class ReconfigureRequest {
  ...
  static datatype() {
    // Returns string type for a dynamic_reconfigure/ReconfigureRequest object
...
class ReconfigureResponse {
  ...
  static datatype() {
    // Returns string type for a dynamic_reconfigure/ReconfigureResponse object
