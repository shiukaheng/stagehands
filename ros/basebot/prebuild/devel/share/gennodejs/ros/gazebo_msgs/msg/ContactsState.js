...
const ContactState = require('./ContactState.js');
...
class ContactsState {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.states.length; ++i) {
      length += ContactState.getMessageSize(object.states[i]);
    }
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/ContactsState object
