...
class ApplyBodyWrenchRequest {
  ...
  static getMessageSize(object) {
    ...
    // 96 is precalculated sum of the constant length fields
    return length + 96;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/ApplyBodyWrenchRequest object
...
class ApplyBodyWrenchResponse {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/ApplyBodyWrenchResponse object
