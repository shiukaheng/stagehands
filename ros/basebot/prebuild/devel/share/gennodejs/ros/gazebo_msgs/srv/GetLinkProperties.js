...
class GetLinkPropertiesRequest {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/GetLinkPropertiesRequest object
...
class GetLinkPropertiesResponse {
  ...
  static getMessageSize(object) {
    ...
    // 118 is precalculated sum of the constant length fields
    return length + 118;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/GetLinkPropertiesResponse object
...
module.exports = {
  ...
  datatype() { return 'gazebo_msgs/GetLinkProperties'; }
};
