...
class SetJointTrajectoryRequest {
  ...
  static getMessageSize(object) {
    ...
    // 62 is precalculated sum of the constant length fields
    return length + 62;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/SetJointTrajectoryRequest object
...
class SetJointTrajectoryResponse {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/SetJointTrajectoryResponse object
