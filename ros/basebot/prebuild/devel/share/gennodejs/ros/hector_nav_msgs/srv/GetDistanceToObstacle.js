...
class GetDistanceToObstacleRequest {
  ...
  static datatype() {
    // Returns string type for a hector_nav_msgs/GetDistanceToObstacleRequest object
...
class GetDistanceToObstacleResponse {
  ...
  static datatype() {
    // Returns string type for a hector_nav_msgs/GetDistanceToObstacleResponse object
