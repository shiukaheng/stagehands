//-----------------------------------------------------------
// Auto-generated from package move_base_msgs.
// !! Do not edit !!
//-----------------------------------------------------------
...
class RecoveryStatus {
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.recovery_behavior_name);
    // 8 is precalculated sum of the constant length fields
    return length + 8;
  }

  static datatype() {
    // Returns string type for a move_base_msgs/RecoveryStatus object
