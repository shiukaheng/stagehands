//-----------------------------------------------------------
// Auto-generated from package polled_camera.
// !! Do not edit !!
//-----------------------------------------------------------
...
const sensor_msgs = _finder('sensor_msgs');
...
class GetPolledImageRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.response_namespace);
    // 37 is precalculated sum of the constant length fields
    return length + 37;
  }

  static datatype() {
    // Returns string type for a polled_camera/GetPolledImageRequest object
...
class GetPolledImageResponse {
  ...
  static getMessageSize(object) {
    ...
    // 13 is precalculated sum of the constant length fields
    return length + 13;
  }

  static datatype() {
    // Returns string type for a polled_camera/GetPolledImageResponse object
