//-----------------------------------------------------------
// Auto-generated from package roscpp_tutorials.
// !! Do not edit !!
//-----------------------------------------------------------
...
class TwoIntsRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let data = new TwoIntsRequest(null);
    let len;
  ...
  static datatype() {
    // Returns string type for a roscpp_tutorials/TwoIntsRequest object
...
`;
  ...
  static Resolve(msg) {
    ...
    const resolved = new TwoIntsRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class TwoIntsResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let data = new TwoIntsResponse(null);
    let len;
  ...
  static datatype() {
    // Returns string type for a roscpp_tutorials/TwoIntsResponse object
...
`;
  ...
  static Resolve(msg) {
    ...
    const resolved = new TwoIntsResponse(null);
...
module.exports = {
  ...
  datatype() { return 'roscpp_tutorials/TwoInts'; }
};
