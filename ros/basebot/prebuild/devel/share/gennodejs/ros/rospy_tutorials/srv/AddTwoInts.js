...
class AddTwoIntsRequest {
  ...
  static datatype() {
    // Returns string type for a rospy_tutorials/AddTwoIntsRequest object
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a rospy_tutorials/AddTwoIntsResponse object
...
module.exports = {
  ...
  datatype() { return 'rospy_tutorials/AddTwoInts'; }
};
