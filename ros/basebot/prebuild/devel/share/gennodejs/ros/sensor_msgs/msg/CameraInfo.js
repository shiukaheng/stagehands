...
const RegionOfInterest = require('./RegionOfInterest.js');
...
class CameraInfo {
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.distortion_model);
    length += 8 * object.D.length
    // 281 is precalculated sum of the constant length fields
    return length + 281;
  }

  static datatype() {
    // Returns string type for a sensor_msgs/CameraInfo object
