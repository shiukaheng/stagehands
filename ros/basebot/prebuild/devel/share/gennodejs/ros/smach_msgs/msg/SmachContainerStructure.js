//-----------------------------------------------------------
// Auto-generated from package smach_msgs.
// !! Do not edit !!
//-----------------------------------------------------------
...
class SmachContainerStructure {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.children.length; ++i) {
      length += 4 + _getByteLength(object.children[i]);
    }
    for(let i = 0; i < object.internal_outcomes.length; ++i) {
      length += 4 + _getByteLength(object.internal_outcomes[i]);
    }
    for(let i = 0; i < object.outcomes_from.length; ++i) {
      length += 4 + _getByteLength(object.outcomes_from[i]);
    }
    for(let i = 0; i < object.outcomes_to.length; ++i) {
      length += 4 + _getByteLength(object.outcomes_to[i]);
    }
    for(let i = 0; i < object.container_outcomes.length; ++i) {
      length += 4 + _getByteLength(object.container_outcomes[i]);
    }
  ...
  static datatype() {
    // Returns string type for a smach_msgs/SmachContainerStructure object
