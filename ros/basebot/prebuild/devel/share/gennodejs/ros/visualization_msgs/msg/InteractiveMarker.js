...
const InteractiveMarkerControl = require('./InteractiveMarkerControl.js');
...
class InteractiveMarker {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.menu_entries.length; ++i) {
      length += MenuEntry.getMessageSize(object.menu_entries[i]);
    }
    for(let i = 0; i < object.controls.length; ++i) {
      length += InteractiveMarkerControl.getMessageSize(object.controls[i]);
    }
    // 76 is precalculated sum of the constant length fields
    return length + 76;
  }

  static datatype() {
    // Returns string type for a visualization_msgs/InteractiveMarker object
