...
const HardwareInterfaceResources = require('./HardwareInterfaceResources.js');
...
class ControllerState {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.claimed_resources.length; ++i) {
      length += HardwareInterfaceResources.getMessageSize(object.claimed_resources[i]);
    }
  ...
  static datatype() {
    // Returns string type for a controller_manager_msgs/ControllerState object
