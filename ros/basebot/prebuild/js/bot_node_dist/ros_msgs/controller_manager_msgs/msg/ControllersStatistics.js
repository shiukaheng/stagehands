...
const ControllerStatistics = require('./ControllerStatistics.js');
...
class ControllersStatistics {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.controller.length; ++i) {
      length += ControllerStatistics.getMessageSize(object.controller[i]);
    }
  ...
  static datatype() {
    // Returns string type for a controller_manager_msgs/ControllersStatistics object
