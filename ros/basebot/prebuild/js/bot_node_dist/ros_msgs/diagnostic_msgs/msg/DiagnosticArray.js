...
const DiagnosticStatus = require('./DiagnosticStatus.js');
...
class DiagnosticArray {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.status.length; ++i) {
      length += DiagnosticStatus.getMessageSize(object.status[i]);
    }
  ...
  static datatype() {
    // Returns string type for a diagnostic_msgs/DiagnosticArray object
