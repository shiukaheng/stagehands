...
const ParamDescription = require('./ParamDescription.js');
...
class Group {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.parameters.length; ++i) {
      length += ParamDescription.getMessageSize(object.parameters[i]);
    }
  ...
  static datatype() {
    // Returns string type for a dynamic_reconfigure/Group object
