...
const SensorPerformanceMetric = require('./SensorPerformanceMetric.js');
...
class PerformanceMetrics {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.sensors.length; ++i) {
      length += SensorPerformanceMetric.getMessageSize(object.sensors[i]);
    }
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/PerformanceMetrics object
