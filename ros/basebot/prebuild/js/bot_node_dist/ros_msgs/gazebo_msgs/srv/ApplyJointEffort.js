...
class ApplyJointEffortRequest {
  ...
  static getMessageSize(object) {
    ...
    // 28 is precalculated sum of the constant length fields
    return length + 28;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/ApplyJointEffortRequest object
...
class ApplyJointEffortResponse {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/ApplyJointEffortResponse object
