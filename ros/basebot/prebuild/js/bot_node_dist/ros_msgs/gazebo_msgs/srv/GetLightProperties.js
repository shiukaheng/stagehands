...
class GetLightPropertiesRequest {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/GetLightPropertiesRequest object
...
class GetLightPropertiesResponse {
  ...
  static getMessageSize(object) {
    ...
    // 45 is precalculated sum of the constant length fields
    return length + 45;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/GetLightPropertiesResponse object
