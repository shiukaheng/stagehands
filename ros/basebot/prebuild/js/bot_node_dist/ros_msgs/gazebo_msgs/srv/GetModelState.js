...
class GetModelStateRequest {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/GetModelStateRequest object
...
class GetModelStateResponse {
  ...
  static getMessageSize(object) {
    ...
    // 109 is precalculated sum of the constant length fields
    return length + 109;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/GetModelStateResponse object
