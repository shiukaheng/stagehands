...
const ODEPhysics = require('../msg/ODEPhysics.js');
...
class GetPhysicsPropertiesRequest {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/GetPhysicsPropertiesRequest object
...
class GetPhysicsPropertiesResponse {
  ...
  static getMessageSize(object) {
    ...
    // 107 is precalculated sum of the constant length fields
    return length + 107;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/GetPhysicsPropertiesResponse object
