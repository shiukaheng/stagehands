...
class GetWorldPropertiesRequest {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/GetWorldPropertiesRequest object
...
class GetWorldPropertiesResponse {
  ...
  static getMessageSize(object) {
    let length = 0;
    for(let i = 0; i < object.model_names.length; ++i) {
      length += 4 + _getByteLength(object.model_names[i]);
    }
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/GetWorldPropertiesResponse object
