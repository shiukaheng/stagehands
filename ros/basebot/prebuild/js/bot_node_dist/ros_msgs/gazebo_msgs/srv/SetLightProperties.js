...
class SetLightPropertiesRequest {
  ...
  static getMessageSize(object) {
    ...
    // 141 is precalculated sum of the constant length fields
    return length + 141;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/SetLightPropertiesRequest object
...
class SetLightPropertiesResponse {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/SetLightPropertiesResponse object
