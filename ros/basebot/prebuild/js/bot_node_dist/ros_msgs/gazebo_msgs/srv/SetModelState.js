...
const ModelState = require('../msg/ModelState.js');
...
class SetModelStateRequest {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/SetModelStateRequest object
...
class SetModelStateResponse {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/SetModelStateResponse object
