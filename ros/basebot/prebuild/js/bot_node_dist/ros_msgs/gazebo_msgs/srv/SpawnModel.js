...
class SpawnModelRequest {
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.model_xml);
    length += _getByteLength(object.robot_namespace);
    length += _getByteLength(object.reference_frame);
    // 72 is precalculated sum of the constant length fields
    return length + 72;
  }

  static datatype() {
    // Returns string type for a gazebo_msgs/SpawnModelRequest object
...
class SpawnModelResponse {
  ...
  static datatype() {
    // Returns string type for a gazebo_msgs/SpawnModelResponse object
