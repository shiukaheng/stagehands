...
const LocalizeActionGoal = require('./LocalizeActionGoal.js');
const LocalizeActionResult = require('./LocalizeActionResult.js');
const LocalizeActionFeedback = require('./LocalizeActionFeedback.js');
...
class LocalizeAction {
  ...
  static datatype() {
    // Returns string type for a nav2d_navigator/LocalizeAction object
