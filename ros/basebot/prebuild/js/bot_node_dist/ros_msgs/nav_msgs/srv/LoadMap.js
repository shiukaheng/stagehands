...
const OccupancyGrid = require('../msg/OccupancyGrid.js');
...
class LoadMapRequest {
  ...
  static datatype() {
    // Returns string type for a nav_msgs/LoadMapRequest object
...
class LoadMapResponse {
  ...
  static getMessageSize(object) {
    ...
    // 1 is precalculated sum of the constant length fields
    return length + 1;
  }

  static datatype() {
    // Returns string type for a nav_msgs/LoadMapResponse object
