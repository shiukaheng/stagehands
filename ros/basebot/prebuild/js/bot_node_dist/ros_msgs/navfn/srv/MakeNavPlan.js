//-----------------------------------------------------------
// Auto-generated from package navfn.
// !! Do not edit !!
//-----------------------------------------------------------
...
class MakeNavPlanRequest {
  ...
  static datatype() {
    // Returns string type for a navfn/MakeNavPlanRequest object
...
class MakeNavPlanResponse {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.path.length; ++i) {
      length += geometry_msgs.msg.PoseStamped.getMessageSize(object.path[i]);
    }
    // 9 is precalculated sum of the constant length fields
    return length + 9;
  }

  static datatype() {
    // Returns string type for a navfn/MakeNavPlanResponse object
