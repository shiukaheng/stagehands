...
class SetLoggerLevelRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.logger);
  ...
  static datatype() {
    // Returns string type for a roscpp/SetLoggerLevelRequest object
...
class SetLoggerLevelResponse {
  ...
  static datatype() {
    // Returns string type for a roscpp/SetLoggerLevelResponse object
