//-----------------------------------------------------------
// Auto-generated from package rosserial_msgs.
// !! Do not edit !!
//-----------------------------------------------------------
...
class RequestParamRequest {
  ...
  static datatype() {
    // Returns string type for a rosserial_msgs/RequestParamRequest object
...
class RequestParamResponse {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.strings.length; ++i) {
      length += 4 + _getByteLength(object.strings[i]);
    }
  ...
  static datatype() {
    // Returns string type for a rosserial_msgs/RequestParamResponse object
