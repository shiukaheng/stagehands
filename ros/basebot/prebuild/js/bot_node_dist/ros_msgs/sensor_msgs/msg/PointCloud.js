...
const ChannelFloat32 = require('./ChannelFloat32.js');
...
class PointCloud {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.channels.length; ++i) {
      length += ChannelFloat32.getMessageSize(object.channels[i]);
    }
  ...
  static datatype() {
    // Returns string type for a sensor_msgs/PointCloud object
