...
const PointField = require('./PointField.js');
...
class PointCloud2 {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.fields.length; ++i) {
      length += PointField.getMessageSize(object.fields[i]);
    }
    length += object.data.length;
    // 26 is precalculated sum of the constant length fields
    return length + 26;
  }

  static datatype() {
    // Returns string type for a sensor_msgs/PointCloud2 object
