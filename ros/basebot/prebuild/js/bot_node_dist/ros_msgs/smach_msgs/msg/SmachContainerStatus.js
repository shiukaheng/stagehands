...
class SmachContainerStatus {
  ...
  static getMessageSize(object) {
    ...
    for(let i = 0; i < object.initial_states.length; ++i) {
      length += 4 + _getByteLength(object.initial_states[i]);
    }
    for(let i = 0; i < object.active_states.length; ++i) {
      length += 4 + _getByteLength(object.active_states[i]);
    }
    length += _getByteLength(object.local_data);
  ...
  static datatype() {
    // Returns string type for a smach_msgs/SmachContainerStatus object
