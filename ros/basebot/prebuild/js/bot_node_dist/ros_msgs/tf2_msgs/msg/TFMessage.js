...
class TFMessage {
  ...
  static getMessageSize(object) {
    let length = 0;
    for(let i = 0; i < object.transforms.length; ++i) {
      length += geometry_msgs.msg.TransformStamped.getMessageSize(object.transforms[i]);
    }
  ...
  static datatype() {
    // Returns string type for a tf2_msgs/TFMessage object
